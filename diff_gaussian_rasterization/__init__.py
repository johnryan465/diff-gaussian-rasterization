...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        ctx.save_for_backward(colors_precomp, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer, camerapos, camerarot)
        return color, radii
    ...
    def backward(ctx, grad_out_color, _):
        ...
        colors_precomp, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer, camerapos, camerarot = ctx.saved_tensors
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None, camerapos = None, camerarot = None):
